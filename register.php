          ...
          <div class="card-body rounded-0">
            <div id="register-form" action="" method="post">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control form-control-sm rounded-0" required="" name="email" id="email" required>
                      </div>
                      <div class="form-group">
                          <label for="contact" class="control-label">Contact</label>
                          <input type="text" class="form-control form-control-sm rounded-0" required="" name="contact" id="contact"  pattern="[6-9]{1}[0-9]{9}"  required maxlength="10">
                      </div>
                      <div class="form-group">
                          <label for="password" class="control-label">Password</label>
                          <div class="input-group input-group-sm">
                              <input type="password" class="form-control form-control-sm rounded-0" required="" name="password" id="password" required>
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-4">
                  <button onclick="customer_registration();" class="btn btn-primary btn-block">Create Account</button>
                </div>
                <!-- /.col -->
              </div>
            </div>
