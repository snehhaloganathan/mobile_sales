...
Class Master extends DBConnection {
    ...
    function place_order(){
        ...
        $insert = $this->conn->query("INSERT INTO `order_list` (`code`, `customer_id`, `delivery_address`, `total_amount`,`payment_mode`,`payment_ref`,`name`,`mobile`,`email`) VALUES ('{$code}', '{$customer_id}', '{$delivery_address}', '{$total_amount}','{$payment_mode}', '{$payment_ref}','{$name}','{$mobile}','{$email}') ") ;
        if($insert){
