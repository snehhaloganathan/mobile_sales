			...
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<thead>
					<tr>
						...
						<th class="p-1 text-center">Payment Ref</th>
				...
				<tbody>
					...
					$qry = $conn->query("SELECT o.*, CONCAT(c.firstname, ' ', c.lastname) as customer from `order_list` o inner join customer_list c on o.customer_id = c.id {$where} order by abs(unix_timestamp(o.date_created)) desc ");
					...
					?>
						<tr>
							...
							<td class="p-1 align-middle"><?= $row['payment_mode'] ?></td>
							<td class="p-1 align-middle"><?= $row['payment_ref'] ?></td>
